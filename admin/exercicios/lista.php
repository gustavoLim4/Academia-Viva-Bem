...
<div class="table-responsivo ">
    <div class="exercicio">
        <table class="table table-bordered border-primary">
            <caption>Lista de exercicio</caption>
            <thead>
                <tr>
                    <th>Id </th>
                    <th>Nome </th>
                    <th>descrição </th>
                    <th>grupoMusculação</th>
                    <th>Status</th>
                    <th>Foto</th>
                    <th>Atualizar</th>
                    <th>Desativar</th>
            ...
            <tbody>
                <?php foreach ($lista as  $linha) : ?>
                    <tr>
                        ...
                        <td> <a class="icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);" href="index.php?p=exercicios&e=atualizar&id=<?php echo $linha['idExercicio']; ?>">
                        ...
                        <td> <a class="icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(0, -.125rem, 0);" href="index.php?p=exercicios&e=desativar&id=<?php echo $linha['idExercicio']; ?>">
